...
\par{ }
\par{     \begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacityback=0, colback=white, bottomrule=.15mm, breakable, toprule=.15mm, rightrule=.15mm, arc=.35mm, left=2mm, leftrule=.75mm]
...
supporting the idea that facial attractiveness significantly shapes
participants' beliefs about reality beliefs pertaining to human faces.
This effect was particularly strong and robust among male participants.
For females, the effect was weaker in Study 1 but more pronounced in
Study 2, which might partly reflect increased statistical power.

Another possibility, however, is that the second sample's experimental
manipulation introduced conflicting cues (e.g., faces labelled
``AI-generated'') that could have disrupted intuitive heuristics,
thereby increasing reliance on attractiveness as a diagnostic cue,
particularly in ambiguous trials.
