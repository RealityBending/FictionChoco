...
\par{ }
\par{     \begin{tcolorbox}[enhanced jigsaw, left=2mm, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, breakable, rightrule=.15mm, toprule=.15mm, colback=white, opacityback=0]
...
\includegraphics[width=0.5\textwidth,height=\textheight]{./figures/fig1.png}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{./figures/fig2.png}
...
al., 2025}). We included all heterosexual male and female participants,
...
(\citeproc{ref-makowski2019indices}{2019}){]}. For the individual-level
...
al., 2024}, \textbf{MORE}; \citeproc{ref-little2021facial}{Little,
2021})\footnote{As an eloquent example, Monk Jr et al.
  (\citeproc{ref-monk2021beholding}{2021}) reported that the the
